...
import { FileUpload } from "../../ui/Input/FileUpload/FileUpload";
    ...
    <Modal isOpen={isOpenModal} onCloseModal={onCloseModal} size="large">
      ...
      <Modal.Content>
        ...
        <FileUpload
          ...
          {...(register ? register("file") : register)}
          isRequired
        />
...
//   toggleDropDown={handleToggleBrandDropDown}
//   refDropDown={refBrandDropDown}
//   defaultValue={selectedBrand && selectedBrand.label}
// >
//   {optionsBrand.map(option => (
//     <DropDown.Option
//       key={option.value}
//       value={option.value}
//       onClick={() => handleOptionClick(option, setSelectedBrand)}
//     >
//       {option.label}
//     </DropDown.Option>
//   ))}
